...
class Near_Red_Base extends OpMode {
    ...
    private final Pose startPose = new Pose(10, 0, Math.toRadians(180)); // Start Pose of our robot.
    private final Pose endPose = new Pose(0, 4, Math.toRadians(90));
